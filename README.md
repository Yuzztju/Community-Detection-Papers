...
5. **Stochastic Block Transition Models for Dynamic Networks.** AISTATS 2015. [paper](http://proceedings.mlr.press/v38/xu15.pdf)
...
2. **Incorporating Implicit Link Preference Into Overlapping Community Detection.** AAAI 2015. [paper](https://dl.acm.org/doi/abs/10.5555/2887007.2887063)

    *Hongyi Zhang, Irwin King, Michael R. Lyu.*

3. **Overlapping community detection at scale: a nonnegative matrix factorization approach.** WSDM 2013.
 [paper](http://i.stanford.edu/~crucis/pubs/paper-nmfagm.pdf)

    *Jaewon Yang, Jure Leskovec.*
    
4. **Identifying overlapping communities as well as hubs and outliers via nonnegative matrix factorization.** Scientific Reports 2013. [paper](https://www.nature.com/articles/srep02993.pdf)
...
1. **Semantic Community Identification in Large Attribute Networks.** AAAI 2016. [paper](https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.1086.6777&rep=rep1&type=pdf)

    *Xiao Wang, Di Jin, Xiaochun Cao, Liang Yang and Weixiong Zhang.*
    
2. **Nonnegative Matrix Tri-Factorization with Graph Regularization for Community Detection in Social Networks.** IJCAI 2015. [paper](https://www.ijcai.org/Proceedings/15/Papers/295.pdf)

    *Yulong Pei, Nilanjan Chakraborty, Katia P. Sycara.*
    
#### Dynamic NMF 

1. **Evolutionary Nonnegative Matrix Factorization Algorithms for Community Detection in Dynamic Networks.** TKDE 2017. [paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7831395)

    *Xiaoke Ma, Di Dong.*
    
2. **Autonomous overlapping community detection in temporal networks: A dynamic Bayesian nonnegative matrix factorization approach.**  KBS 2016. [paper](https://reader.elsevier.com/reader/sd/pii/S0950705116302350?token=1F3E0DFFE8BA576C15F2654D8318D892EB4267ACDA3E0962BF5487B25E841834D2FF2B7E4EEBEC54EB46F85635636859)
